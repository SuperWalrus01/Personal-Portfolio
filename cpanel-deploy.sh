...
if ! command -v npm >/dev/null 2>&1; then
  echo "[deploy] npm not found in PATH. If you prefer building locally, run 'npm run build' locally and push the build/ output to the repo or set up a Node.js app in cPanel." >&2
  exit 1
fi
